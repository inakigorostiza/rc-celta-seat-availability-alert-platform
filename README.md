...
| [`generate-sessions.js`](generate-sessions.js) | Produces `onebox-sessions-cards.html` — a card-grid view of every session with per-sector availability. |
...
node generate-sessions.js    # → onebox-sessions-cards.html
